    ...
    return (
        <>
            <Head>
                ...
                {/* No Meta pixel here: the QuoteMate dataset (1714708188811919) is
                    the paid-acquisition dataset for quotemateapp.au. Portfolio
                    PageViews from this domain polluted campaign baselines and the
                    SignupStart optimisation signal, so the install was removed
                    2026-07-27. The pixel lives in the QuoteMateAppWebsite repo
                    (app/components/AttributionBridge.tsx). */}
            </Head>
