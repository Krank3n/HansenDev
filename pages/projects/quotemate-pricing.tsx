...
const QuoteMatePricing: React.FC = () => {
    ...
    const roiCalculations = [
        {
            ...
            cost: "$29/month",
            roi: "$691 saved vs $29 cost = 24x ROI",
        ...
        },
        {
            ...
            cost: "$29/month",
            roi: "$1,411 saved vs $29 cost = 49x ROI",
        ...
        },
        {
            ...
            cost: "$29/month",
            roi: "$2,851 saved vs $29 cost = 99x ROI",
    ...
    const costComparisons = [
        ...
        },
        {
            ...
            cost: "$3.50",
            frequency: "Once",
            yearly: "8 sausages = 1 month subscription"
        },
        {
            item: "Tradie Coffee",
            cost: "$5.50",
            frequency: "Daily",
            yearly: "$2,000/year (5 days = 1 month)"
        },
        {
            item: "One Lost Quote (Outdated Price)",
            cost: "$150-500",
            frequency: "Once",
            yearly: "1 mistake = 5-17 months of QuoteMate"
        },
        {
    ...
    const commonObjections = [
        {
            ...
            answer: "Yes! Even 2 quotes/week = 8 quotes/month. At 2 hours saved per quote, that's 16 hours saved for $29. That's basically 94 cents per hour to not do admin. Plus you'll likely win more jobs with professional quotes, so you might end up doing more quotes anyway."
        },
        {
        ...
        {
            objection: "\"$29/month seems expensive for an app...\"",
            answer: "If QuoteMate saves you 2 hours on just ONE quote per month, that's $120 of your time (at $60/hr) for a $29 cost. That's a 4x return on your first quote alone. Every other quote that month is pure time savings."
        },
        {
            objection: "\"I might not use it enough to justify the cost...\"",
            answer: "That's why we give you a full 7-day free trial! Try it on real jobs with unlimited quotes. See how much time it actually saves YOU. If you don't think it's worth it after the trial, don't subscribe."
        },
        {
    ...
    return (
        <>
            <Head>
                <title>QuoteMate Pricing - Free Trial + $29/month for Unlimited Quotes | See ROI Calculator</title>
                <meta name="description" content="QuoteMate pricing: 7-day free trial, then $29/month for unlimited quotes. Save 12+ hours/month. ROI calculator shows you save $691+/month vs $29 cost. 30-day money-back guarantee. No lock-in contract. See cost comparison & savings." />
                ...
                <meta property="og:title" content="QuoteMate Pricing - 7-Day Free Trial, Then $29/month" />
                <meta property="og:description" content="7-day free trial. Then $29/month for unlimited quotes. See ROI calculator showing you save $691+/month. 30-day money-back guarantee." />
                <meta property="og:locale" content="en_AU" />

                {/* Twitter Card */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="QuoteMate Pricing - 7-Day Free Trial, Then $29/month" />
                <meta name="twitter:description" content="Save 12+ hours/month for $29. 7-day free trial. See the ROI calculator." />
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "description": "Complete pricing guide for QuoteMate including free trial, monthly and yearly plans, ROI calculations, cost comparisons, and answers to common pricing questions. See how tradies save 12+ hours per month and achieve 24-99x ROI.",
                            "author": {
                                "@type": "Organization",
                                "name": "Hansen Dev"
                            },
                        ...
                        __html: JSON.stringify({
                            ...
                            "offers": [
                                ...
                                },
                                {
                                    ...
                                    "description": "Pro Yearly - Save 43%",
                                    "availability": "https://schema.org/InStock"
                                }
                            ]
                        })
                            ...
                            "mainEntity": [
                                {
                                    ...
                                    "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "QuoteMate offers a 7-day free trial with unlimited quotes and no credit card required. After that, it's $29 per month for unlimited quotes, or $199 per year (saving 43%). Both plans include all features: AI estimation, real-time Bunnings pricing, professional PDFs, and offline functionality."
                                    }
                                },
                                {
                                    "@type": "Question",
                                    ...
                                    "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "If you do 5 quotes per month, QuoteMate saves you approximately 12 hours. At $60/hour labour rate, that's $720 in time savings vs $29/month cost - a 24x return on investment. For 10 quotes per month, you save 24 hours ($1,440) for a 49x ROI. Most tradies see their subscription pay for itself with just the first quote of the month."
                                    }
                                },
                                {
                                    "@type": "Question",
                                    ...
                                    "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Yes! QuoteMate gives you a full 7-day free trial with unlimited quotes. All features are unlocked during the trial - AI estimation, Bunnings pricing, professional PDFs, everything. No credit card required to start. The trial begins when you create your first quote."
                                    }
                                },
                                {
                                    "@type": "Question",
                                ...
                                },
                                {
                                    ...
                                    "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Manual quoting typically takes 2-3 hours per quote. QuoteMate reduces this to under 5 minutes. For $29/month, if you save 2 hours on just one quote, that's $120 in time savings (at $60/hr) vs $29 cost. Unlike Excel, QuoteMate provides real-time Bunnings pricing, AI-powered material calculations, automatic PDF generation, and works offline on your phone."
                                    }
                                },
                                {
                                    "@type": "Question",
                                    "name": "Is $29/month worth it if I only do a few quotes?",
                                    "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Even if you only do 2 quotes per week (8 per month), saving 2 hours per quote equals 16 hours saved monthly. At $60/hour, that's $960 in time savings for a $29 cost - a 33x ROI. Plus, professional quotes help you win more jobs, so you'll likely do more quotes."
                                    }
                                }
                            ]
                        })
                    ...
                    <div className="container-custom relative">
                        <div className="max-w-5xl mx-auto text-center">
                            ...
                            <p className="text-2xl lg:text-3xl text-dark-text-secondary mb-8 leading-relaxed max-w-3xl mx-auto">
                                7-day free trial, then <span className="text-brand-accent font-bold">$29/month</span> for unlimited quotes. Save <span className="text-brand-accent font-bold">12+ hours per month</span> on quoting
                            </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl text-dark-text-secondary leading-relaxed mb-4">
                                            If you do just <span className="text-white font-bold">ONE quote in your first month</span>, QuoteMate has already paid for itself <span className="text-brand-accent font-bold">4 times over</span> (based on 2hrs saved × $60/hr = $120 vs $29 cost).
                                        </p>
                    ...
                    <div className="container-custom">
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl text-dark-text-secondary">
                                    Here's what $29/month really means
                                </p>
                            </div>
                            ...
                            <div className="mt-12 grid md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-brand-accent/10 rounded-2xl p-8 ">
                                    ...
                                    <div className="mt-6 pt-6 ">
                                        <div className="text-brand-accent font-bold text-lg">Cost: $29/month</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-xl text-dark-text-secondary mb-8 max-w-2xl mx-auto">
                                7-day free trial with unlimited quotes. No credit card. No commitment. Just results.
                            </p>
